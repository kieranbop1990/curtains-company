...
export default function CustomersUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setContactNum(cleanValues.contactNum);
    setAccountsContact(cleanValues.accountsContact);
    setRegNumber(cleanValues.regNumber);
    setTrustedPayer(cleanValues.trustedPayer);
    setCreditLimit(cleanValues.creditLimit);
    setBillingAddress(cleanValues.billingAddress);
    setAccountsEmail(cleanValues.accountsEmail);
    setVatNumber(cleanValues.vatNumber);
    setTaxReference(cleanValues.taxReference);
    setVatExempt(cleanValues.vatExempt);
    setVatReverse(cleanValues.vatReverse);
    setCisDeductions(cleanValues.cisDeductions);
    setCisName(cleanValues.cisName);
    setCisRate(cleanValues.cisRate);
    setCisOrgType(cleanValues.cisOrgType);
    setErrors({});
  };
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Customers, idProp)
        : customersModelProp;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Customers.copyOf(customersRecord, (updated) => {
